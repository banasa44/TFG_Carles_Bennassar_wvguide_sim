...
class Sizes ():
 #versió espaiat constant
    version = 'continous alpha; l_0 varying, R=0.025'

    #número de blocks que es faran servir a la simulació
    num_blocks = 24

    pml_size = 1.0

    # Tamanys del block de silici que fa els gratings (Z doncs correspondria al etching)
    block_x = 0.425
    block_y = 8.0
    block_z = 0.07
    ...
    src_center_xz = mp.Vector3(-(alpha*num_blocks/4),-1.3,0)
